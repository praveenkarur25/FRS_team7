    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="http://localhost:9080/FRS/ChangePassword.jsp" style="color:black;"><i class="fas fa-user" style="color:black;"></i>Change Password</a>
						</div>
		</li>
      <li class="nav-item">
				...
				<div class="row">
					<div class="col">
						<div class="input-field">
							...
							<input type="text" id="state" name="state" placeholder="" value=<%=resultSet.getString("state")%> required/>
						</div>
					</div>
					<div class="col">
						<div class="input-field">
							<label for="pincode">Pincode&emsp;:</label>
							<input type="tel" id="pincode" name="pincode" pattern="[0-9]{6}" maxlength="6" style="width:210px;" placeholder="" value=<%=resultSet.getString("pincode")%> required/>
						</div>
					</div>
